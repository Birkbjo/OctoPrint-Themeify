...
a.ownSettings.enabled()&&$.attr("html","class")!=a.classId&&"touch"!==$("html").attr("id")&&(a.ownSettings.enableAutoswitch()&&(b>=a.ownSettings.nightTimeStart()||b<a.ownSettings.nightTimeEnd())&&!$("html").hasClass(a.ownSettings.nightTheme())?$("html").addClass(a.ownSettings.nightTheme()).removeClass(a.ownSettings.theme()):a.ownSettings.enableAutoswitch()&&(b>=a.ownSettings.nightTimeStart()||b<a.ownSettings.nightTimeEnd())||$("html").hasClass(a.ownSettings.theme())||$("html").addClass(a.ownSettings.theme()).removeClass(a.ownSettings.nightTheme()))};
