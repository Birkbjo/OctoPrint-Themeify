...
d){a._subscribeToCustomRules(b,c)});else if("color"==c){a.configSubscriptions[c]=[];var e=a.onColorChange;a.ownSettings.color().map(function(b,d){a._subscribeToCustomRules(b,c,e)})}else{var g=a.configOnChangeMap[c]?a.configOnChangeMap[c]:a.onChange.bind(b,c);a.configSubscriptions[c]=a.ownSettings[c].subscribe(g)}})};a._timer=function(){var b=new Date,b=new Date(b.getFullYear(),b.getMonth(),b.getDate(),b.getHours()+1,0,0,0)-b;100<b&&setTimeout(function(){a._timer()},b);a._autoCheck()};a._autoCheck=
function(){var b=(new Date).getHours();a.ownSettings.enabled()&&$.attr("html","class")!=a.classId&&"touch"!==$("html").attr("id")&&(a.ownSettings.enableAutoswitch()&&(b>=a.ownSettings.nightTimeStart()||b<a.ownSettings.nightTimeEnd())&&!$("html").hasClass(a.ownSettings.nightTheme())?$("html").addClass(a.ownSettings.nightTheme()).removeClass(a.ownSettings.theme()):a.ownSettings.enableAutoswitch()&&(b>=a.ownSettings.nightTimeStart()||b<a.ownSettings.nightTimeEnd())||$("html").hasClass(a.ownSettings.theme())||
$("html").addClass(a.ownSettings.theme()).removeClass(a.ownSettings.nightTheme()))};a.onSettingsHidden=function(){Object.keys(a.configSubscriptions).map(function(b,c){Array.isArray(a.configSubscriptions[b])?a.configSubscriptions[b].forEach(function(a){a.dispose()}):a.configSubscriptions[b].dispose()})};a.configOnChangeMap={enabled:a.onEnabledChange,theme:a.onThemeChange,nightTheme:a.onNightThemeChange,nightTimeStart:a.onNightTimeStartChange,nightTimeEnd:a.onNightTimeEndChange,enableCustomization:a.onEnableCustomizationChange,
enableAutoswitch:a.onEnableAutoswitchChange}},["settingsViewModel"],["#settings_plugin_themeify"]])});
